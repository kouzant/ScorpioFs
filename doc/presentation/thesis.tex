...
Το περιεχόμενο της ταινίας ήταν διαθέσιμο μέχρι και όταν 52/58 $\simeq \log(58)$ κόμβους του δικτύου είχαν τερματίσει τη λειτουργία τους αφού ``έτρεχαν για 30'''
}
\frame{
\frametitle{Διαθεσιμότητα}
\begin{figure}
