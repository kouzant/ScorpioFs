...
static int javafs_getattr(const char *path, struct stat *stbuf)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.I__getattr__Ljava_nio_ByteBuffer_Lfuse_FuseGetattrSetter_, jPath, jGetattr);
      if (exception_check_jerrno(env, &jerrno)) break;
...
static int javafs_readlink(const char *path, char *buf, size_t size)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.I__readlink__Ljava_nio_ByteBuffer_Ljava_nio_ByteBuffer_, jPath, jLink);
      if (exception_check_jerrno(env, &jerrno)) break;

      // write a cstring terminator at the end of writen data
      jLinkPosition = (*env)->CallIntMethod(env, jLink, ByteBuffer->method.I__position);
      if (exception_check_jerrno(env, &jerrno)) break;
      buf[jLinkPosition] = '\0';
...
static int javafs_getdir(const char *path, fuse_dirh_t h, fuse_dirfil_t filler)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.I__getdir__Ljava_nio_ByteBuffer_Lfuse_FuseFSDirFiller_, jPath, jDirEntList);
      if (exception_check_jerrno(env, &jerrno)) break;

      n = (*env)->CallIntMethod(env, jDirEntList, FuseFSDirFiller->method.I__size);
      if (exception_check_jerrno(env, &jerrno)) break;
      ...
      for (i = 0; i < n; i++)
      {
         ...
         jDirEnt = (*env)->CallObjectMethod(env, jDirEntList, FuseFSDirFiller->method.Ljava_lang_Object___get__I, i);
         if (exception_check_jerrno(env, &jerrno)) break;
...
static int javafs_mknod(const char *path, mode_t mode, dev_t rdev)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.I__mknod__Ljava_nio_ByteBuffer_II, jPath, (jint)mode, (jint)rdev);
...
static int javafs_mkdir(const char *path, mode_t mode)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.I__mkdir__Ljava_nio_ByteBuffer_I, jPath, (jint)mode);
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_unlink(const char *path)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.I__unlink__Ljava_nio_ByteBuffer_, jPath);
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_rmdir(const char *path)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.I__rmdir__Ljava_nio_ByteBuffer_, jPath);
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_symlink(const char *from, const char *to)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.I__symlink__Ljava_nio_ByteBuffer_Ljava_nio_ByteBuffer_, jFrom, jTo);
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_rename(const char *from, const char *to)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.I__rename__Ljava_nio_ByteBuffer_Ljava_nio_ByteBuffer_, jFrom, jTo);
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_link(const char *from, const char *to)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.I__link__Ljava_nio_ByteBuffer_Ljava_nio_ByteBuffer_, jFrom, jTo);
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_chmod(const char *path, mode_t mode)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.I__chmod__Ljava_nio_ByteBuffer_I, jPath, (jint)mode);
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_chown(const char *path, uid_t uid, gid_t gid)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.I__chown__Ljava_nio_ByteBuffer_II, jPath, (jint)uid, (jint)gid);
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_truncate(const char *path, off_t size)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.I__truncate__Ljava_nio_ByteBuffer_J, jPath, (jlong)size);
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_utime(const char *path, struct utimbuf *buf)
{
   ...
   while (1)
   {
      ...
      (*env)->CallVoidMethod(env, fuseFS, FuseFS->method.I__utime__Ljava_nio_ByteBuffer_II, jPath, (jint)(buf->actime), (jint)(buf->modtime));
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_open(const char *path, struct fuse_file_info *ffi)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.I__open__Ljava_nio_ByteBuffer_ILfuse_FuseOpenSetter_, jPath, (jint)(ffi->flags), jOpen);
      if (exception_check_jerrno(env, &jerrno)) break;
...
static int javafs_read(const char *path, char *buf, size_t size, off_t offset, struct fuse_file_info *ffi)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.I__read__Ljava_nio_ByteBuffer_Ljava_lang_Object_Ljava_nio_ByteBuffer_J, jPath, (jobject) (ffi->fh), jBuf, (jlong)offset);
      if (exception_check_jerrno(env, &jerrno)) break;

      // to obtain # of bytes read, get current position from ByteBuffer
      nread = (*env)->CallIntMethod(env, jBuf, ByteBuffer->method.I__position);
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_write(const char *path, const char *buf, size_t size, off_t offset, struct fuse_file_info *ffi)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.I__write__Ljava_nio_ByteBuffer_Ljava_lang_Object_ZLjava_nio_ByteBuffer_J, jPath, (jobject) (ffi->fh), (ffi->writepage)? JNI_TRUE : JNI_FALSE, jBuf, (jlong)offset);
      if (exception_check_jerrno(env, &jerrno)) break;

      // to obtain # of bytes writen, get current position from ByteBuffer
      nwriten = (*env)->CallIntMethod(env, jBuf, ByteBuffer->method.I__position);
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_statfs(const char *path, struct statfs *fst)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.I__statfs__Lfuse_FuseStatfsSetter_, jStatfs);
      if (exception_check_jerrno(env, &jerrno)) break;
...
static int javafs_flush(const char *path, struct fuse_file_info *ffi)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.I__flush__Ljava_nio_ByteBuffer_Ljava_lang_Object_, jPath, (jobject) (ffi->fh));
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_release(const char *path, struct fuse_file_info *ffi)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.I__release__Ljava_nio_ByteBuffer_Ljava_lang_Object_I, jPath, jFh, (jint)(ffi->flags));
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_fsync(const char *path, int datasync, struct fuse_file_info *ffi)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.I__fsync__Ljava_nio_ByteBuffer_Ljava_lang_Object_Z, jPath, (jobject) (ffi->fh), (jint)(ffi->flags), datasync? JNI_TRUE : JNI_FALSE);
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_setxattr(const char *path, const char *name, const char *value, size_t size, int flags)
{
   ...
   while(1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.I__setxattr__Ljava_nio_ByteBuffer_Ljava_nio_ByteBuffer_Ljava_nio_ByteBuffer_I, jPath, jName, jValue, (jint)flags);
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_getxattr(const char *path, const char *name, char *value, size_t size)
{
   ...
   while (1)
   {
      ...
      if (size == 0)
      {
         ...
         jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.I__getxattrsize__Ljava_nio_ByteBuffer_Ljava_nio_ByteBuffer_Lfuse_FuseSizeSetter_, jPath, jName, jSize);
         if (exception_check_jerrno(env, &jerrno)) break;
      ...
      else
      {
         ...
         jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.I__getxattr__Ljava_nio_ByteBuffer_Ljava_nio_ByteBuffer_Ljava_nio_ByteBuffer_, jPath, jName, jValue);
         if (exception_check_jerrno(env, &jerrno)) break;

         // to obtain # of bytes read, get current position from ByteBuffer
         xattrsize = (*env)->CallIntMethod(env, jValue, ByteBuffer->method.I__position);
      }
...
static int javafs_listxattr(const char *path, char *list, size_t size)
{
   ...
   while (1)
   {
      ...
      if (size == 0)
      {
         ...
         jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.I__listxattrsize__Ljava_nio_ByteBuffer_Lfuse_FuseSizeSetter_, jPath, jSize);
         if (exception_check_jerrno(env, &jerrno)) break;
      ...
      else
      {
         ...
         jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.I__listxattr__Ljava_nio_ByteBuffer_Ljava_nio_ByteBuffer_, jPath, jList);
         if (exception_check_jerrno(env, &jerrno)) break;

         // to obtain # of bytes read, get current position from ByteBuffer
         xattrsize = (*env)->CallIntMethod(env, jList, ByteBuffer->method.I__position);
      }
...
static int javafs_removexattr(const char *path, char *name)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.I__removexattr__Ljava_nio_ByteBuffer_Ljava_nio_ByteBuffer_, jPath, jName);
      exception_check_jerrno(env, &jerrno);
      break;
   }
